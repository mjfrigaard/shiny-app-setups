...
`shiny-app-setups` contains setups for 1) A vanilla shiny app (`VanillaApp`), 2) an app built as an R package (`myPkgApp`), 2) a `golem` shiny app (`myGolemApp`) 3) a `leprechaun` app (`myLeprechaunApp`), and 4) a `rhino` app (`myRhinoApp`).  
